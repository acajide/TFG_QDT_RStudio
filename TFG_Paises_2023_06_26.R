...
#Directorio
data <- readRDS("C:/Users/mapay/OneDrive - Universidade de Santiago de Compostela/Doctorado Yago/Turismo/Datos/Estadisticas individuales oficina del peregrino/data.rds")
...
#ESPAÑA
grupo1_pais01 <- pais01 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais01 <- pais01 %>% anti_join(grupo1_pais01) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais01 <- pais01 %>% anti_join(grupo1_pais01) %>% anti_join(grupo2_pais01)  # 10% de los datos
#PORTUGAL
grupo1_pais02 <- pais02 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais02 <- pais02 %>% anti_join(grupo1_pais02) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais02 <- pais02 %>% anti_join(grupo1_pais02) %>% anti_join(grupo2_pais02)  # 10% de los datos
#ALEMANIA
grupo1_pais03 <- pais03 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais03 <- pais03 %>% anti_join(grupo1_pais03) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais03 <- pais03 %>% anti_join(grupo1_pais03) %>% anti_join(grupo2_pais03)  # 10% de los datos
#ITALIA
grupo1_pais04 <- pais04 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais04 <- pais04 %>% anti_join(grupo1_pais04) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais04 <- pais04 %>% anti_join(grupo1_pais04) %>% anti_join(grupo2_pais04)  # 10% de los datos
#ESTADOS UNIDOS
grupo1_pais05 <- pais05 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais05 <- pais05 %>% anti_join(grupo1_pais05) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais05 <- pais05 %>% anti_join(grupo1_pais05) %>% anti_join(grupo2_pais05)  # 10% de los datos
#BRASIL
grupo1_pais06 <- pais06 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais06 <- pais06 %>% anti_join(grupo1_pais06) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais06 <- pais06 %>% anti_join(grupo1_pais06) %>% anti_join(grupo2_pais06)  # 10% de los datos
#REPLÚBLICA CHECA
grupo1_pais07 <- pais07 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais07 <- pais07 %>% anti_join(grupo1_pais07) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais07 <- pais07 %>% anti_join(grupo1_pais07) %>% anti_join(grupo2_pais07)  # 10% de los datos
#HOLANDA
grupo1_pais08 <- pais08 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais08 <- pais08 %>% anti_join(grupo1_pais08) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais08 <- pais08 %>% anti_join(grupo1_pais08) %>% anti_join(grupo2_pais08)  # 10% de los datos
#REINO UNIDO
grupo1_pais09 <- pais09 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais09 <- pais09 %>% anti_join(grupo1_pais09) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais09 <- pais09 %>% anti_join(grupo1_pais09) %>% anti_join(grupo2_pais09)  # 10% de los datos
#POLONIA
grupo1_pais10 <- pais10 %>% sample_frac(0.7)  # 70% de los datos
grupo2_pais10 <- pais10 %>% anti_join(grupo1_pais10) %>% sample_frac(2/3)  # 20% de los datos
grupo3_pais10 <- pais10 %>% anti_join(grupo1_pais10) %>% anti_join(grupo2_pais10)  # 10% de los datos


#Modelo FASE DE ENTRENAMIENTO
...
mean(model_pais01$data$Portugues_distancia)
mean(model_pais02$data$Portugues_distancia)
mean(model_pais03$data$Portugues_distancia)
mean(model_pais04$data$Portugues_distancia)
mean(model_pais05$data$Portugues_distancia)
mean(model_pais06$data$Portugues_distancia)
mean(model_pais07$data$Portugues_distancia)
mean(model_pais08$data$Portugues_distancia)
mean(model_pais09$data$Portugues_distancia)
mean(model_pais10$data$Portugues_distancia)
...
mean(model_pais01_grupo2$data$Portugues_distancia)
mean(model_pais02_grupo2$data$Portugues_distancia)
mean(model_pais03_grupo2$data$Portugues_distancia)
mean(model_pais04_grupo2$data$Portugues_distancia)
mean(model_pais05_grupo2$data$Portugues_distancia)
mean(model_pais06_grupo2$data$Portugues_distancia)
mean(model_pais07_grupo2$data$Portugues_distancia)
mean(model_pais08_grupo2$data$Portugues_distancia)
mean(model_pais09_grupo2$data$Portugues_distancia)
mean(model_pais10_grupo2$data$Portugues_distancia)
...
data_excel <- read_excel("C:/Users/alejandro.cajide/Documents/Papeleo/USC/TFG/Inglehart_Schwartz_Hofstede.xlsx", sheet = 2)
...
mean(model_pais1_grupo3$data$Portugues_distancia)
mean(model_pais2_grupo3$data$Portugues_distancia)
mean(model_pais3_grupo3$data$Portugues_distancia)
mean(model_pais4_grupo3$data$Portugues_distancia)
mean(model_pais5_grupo3$data$Portugues_distancia)
mean(model_pais6_grupo3$data$Portugues_distancia)
mean(model_pais7_grupo3$data$Portugues_distancia)
mean(model_pais8_grupo3$data$Portugues_distancia)
mean(model_pais9_grupo3$data$Portugues_distancia)
mean(model_pais10_grupo3$data$Portugues_distancia)
